  ...
  useEffect(() => {
    if (products.length > 0) {
      ...
      productCopy = productCopy.filter((item) => {
        return (
          product.category === item.category && item._id !== id && item.inStock
        );
      });
      ...
      <div className="mt-12">
        ...
        <div className="flex flex-col md:flex-row gap-16 mt-4">
          ...
          <div className="text-sm w-full md:w-1/2">
            ...
            <div className="flex items-center gap-0.5 mt-1">
              ...
              <p className="text-base ml-2">(3)</p>
            </div>
        ...
        <div className="flex flex-col items-center mt-20">
          ...
          <button
            ...
            className="mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-primary hover:bg-primary/10 transition text-xl"
          >
            See More
          </button>
        </div>
