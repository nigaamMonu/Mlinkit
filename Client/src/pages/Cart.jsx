...
const Cart = () => {
    ...
    const {getCartItemsCount, getCartAmount, products,cartItems,removeFromCart, updateCartItem,navigate, axios, user ,setCartItems} = useAppContext();
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
        ...
        <div className="mb-6">
          ...
          <div className="relative flex justify-between items-start mt-2">
            <p className="text-gray-500 overflow-x-hidden">{selectedAddress? `${selectedAddress.street},${selectedAddress.city},${selectedAddress.state},${selectedAddress.country}`:"No address found"}</p>
            <button
        ...
        <div className="text-gray-500 mt-4 space-y-2">
          ...
          <p className="flex justify-between">
            <span>Tax (2%)</span>
            <span>Rs{Math.ceil(getCartAmount()*(0.02))}</span>
          </p>
          <p className="flex justify-between text-lg font-medium mt-3">
            <span>Total Amount:</span>
            <span>Rs{getCartAmount()+Math.ceil(getCartAmount()*(0.02))}</span>
          </p>
        </div>
